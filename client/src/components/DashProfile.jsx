  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        {
          currentUser.isAdmin && (
            <Link to={'/create-post'}> {/*Si poses /create-post et port a a la pagina /create-post, sinó poses la / et porta a la pagina que estás + el create post: /dashboard/create-post*/ }
        ...
        <Modal.Header/>
          <Modal.Body>
            <div className='text-center'>
              ...
              <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you want to delete yor account? </h3>
